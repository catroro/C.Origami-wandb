...
class TrainModule(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        # log and visualize training metrics and predictions
    ...
    def configure_optimizers(self):
        ...
        import pl_bolts
        scheduler = pl_bolts.optimizers.lr_scheduler.LinearWarmupCosineAnnealingLR(optimizer, warmup_epochs=10, max_epochs=self.args.trainer.max_epochs)
        scheduler_config = {
            'scheduler': scheduler,
            'interval': 'epoch',
            'frequency': 1,
    ...
    def get_dataloader(self, args, mode):
        ...
        if not args.dataloader.ddp_disabled:
            gpus = args.trainer.num_gpu
